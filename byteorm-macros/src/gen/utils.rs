...
pub fn is_builtin_type(ty: &str) -> bool {
    matches!(ty, "BigInt" | "Int" | "String" | "JsonB" | "TimestamptZ" | "Timestamp" | "Boolean" | "Float" | "Serial" | "Real" | "Text" | "Date")
}
...
pub fn generate_where_methods(model: &Model, target_args: &str, target_fragments: &str) -> impl Iterator<Item = TokenStream> + '_ {
...
pub fn generate_set_methods(model: &Model, use_hashmap: bool, hashmap_field: &str, vec_field: Option<&str>, fragments_field: Option<&str>) -> impl Iterator<Item = TokenStream> + '_ {
            ...
            if is_enum {
                quote! {
                    pub fn #method_name(mut self, value: #field_type) -> Self {
                        ...
                        self.#frags_ident.push(#field_col.to_string());
                        self
                    }
                }
            } else {
...
pub fn generate_inc_methods(model: &Model, target_ops: &str, target_values: Option<&str>) -> impl Iterator<Item = TokenStream> + '_ {
    model.fields.iter()
